...
def generate_index_html(results_dir: Path) -> None:
    ...
    for json_file in results_dir.glob("comparison_*.json"):
        try:
            ...
            logger.warning("Error procesando %s: %s", json_file, e)
...
<body>
    <div class="container">
        ...
        <div class="github-info">
            ...
            <a href="https://github.com/{os.environ.get('GITHUB_REPOSITORY', 'your-user/smartVisionQA')}">View on GitHub</a> • 
    ...
    logger.info("Índice generado: %s", index_path)
